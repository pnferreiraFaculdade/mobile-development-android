...
public class MainActivity extends AppCompatActivity {
    ...
    public void abrirAlertDialog(View view) {
        ...
        builder.setTitle(R.string.eu_sou_um_alert_dialog);
        builder.setMessage(R.string.coneudo_do_alert);
    ...
    public void abrirProgressDialog(View view) {
        ...
        pd.setTitle(getString(R.string.eu_sou_um_progress_dialog));
        pd.setMessage(getString(R.string.aguarde));
        pd.show();
        //pd.dismiss(); Fecha o Dialogo
    }
    ...
    public void abrirDialogPersonalizado(View view) {
        ...
        dialog.setTitle(R.string.persolazido);
